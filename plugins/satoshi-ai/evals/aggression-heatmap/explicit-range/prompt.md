---
description: A range the person names is honoured with the direct tape tools, in one call, without refusing it for being wider than the widget.
tags: [aggression-heatmap]
max_turns: 15
